...
- `success_url`: The URL to redirect the user back to upon approval.
...
All subsequent REST API calls should include standard **HTTP Basic Authentication** headers using the username and the clean Application Password.
