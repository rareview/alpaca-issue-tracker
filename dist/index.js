    ...
    useEffect(()=>{
        if (issueId && isOpen) {
            ...
            Promise.all([
                ...
                if (issueData.meta.checklist) try {
                    const parsedChecklist = typeof issueData.meta.checklist === "string" ? JSON.parse(issueData.meta.checklist) : issueData.meta.checklist;
