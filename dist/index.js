...
const Item = forwardRef(({ id, content, author_name, author_img, comment_count, className, style, ...props }, ref)=>{
    return /*#__PURE__*/ React.createElement("div", {
        ...
        __self: undefined
    }) : "", author_name), typeof comment_count !== "undefined" && comment_count > 0 && /*#__PURE__*/ React.createElement("div", {
        className: "alpaca-item-comment-count",
        __source: {
            fileName: "src/board.jsx",
            lineNumber: 115,
            columnNumber: 13
 ...
 */ function SortableItem({ id, content, className, isDragDisabled = false, onClick, author_name, author_img = "", comment_count }) {
...
const AlpacaIssue = ({ issueId, isOpen, onClose, triggerRef, onCommentCountChange })=>{
    ...
    useEffect(()=>{
        if (issueId && isOpen) {
            ...
            wp.apiFetch({
                ...
                if (data.taxonomies && data.taxonomies.assignee && Array.isArray(data.taxonomies.assignee)) setAssignees(data.taxonomies.assignee.map((t)=>Object.keys(userMap).find((k)=>userMap[k] === (t.username || t.name)) || t.username || t.name));
                else setAssignees([]);
            }).catch((err)=>{
