...
},{"./alpaca.scss":"1ItKB","./apitest.js":"jb82X","./modal.jsx":"lBZco","./settings.jsx":"aIYcP","./board.jsx":"h1t0l","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./context/WatchlistContext.jsx":"WrED9"}],"1ItKB":[function() {},{}],"jb82X":[function(require,module,exports,__globalThis) {
...
},{"./BoardMain":"1nh76","../utils/cookies":"4qoXW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1nh76":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
    ...
    const handleAssigneesChange = async (issueId, newAssignees)=>{
        const enrichedAssignees = await Promise.all(newAssignees.map(async (assignee)=>{
            if (assignee && assignee.id && !assignee.display_name) try {
                const fullUser = await (0, _usercache.getUser)(assignee.id);
                return {
                    ...assignee,
...
},{"./issue":"l6q71","./Item":"2yEr4","./Container":"QNfzH","../utils/cookies":"4qoXW","../utils/data":"j8lWA","../utils/comments":"hPhNI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@atlaskit/pragmatic-drag-and-drop-react-beautiful-dnd-migration":"iD7mF","../utils/usercache":"gUv4D"}],"l6q71":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const TabContent = ReactMemo(({ tab, issueDetails, issueId, onCommentCountChange, commentRefreshKey, onScreenshotDelete, loadingStates, onScreenshotClick })=>{
    switch(tab.name){
        case "comments":
...
const AlpacaIssue = ({ issueId, isOpen, onClose, onDelete, triggerRef, onCommentCountChange, onAssigneesChange, onDeadlineChange, createIssueComment, generateAssigneeChangeComment })=>{
    ...
    const handleChecklistComment = useCallback((issueId, commentContent)=>{
    ...
    return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(Modal, {
        ...
        headerActions: /*#__PURE__*/ React.createElement(Tooltip, {
            text: "Delete issue",
            __source: {
                fileName: "src/components/issue.jsx",
                lineNumber: 711,
        ...
        __self: undefined
    }, issueDetails.post_data.post_name), /*#__PURE__*/ React.createElement("h3", {
...
const Checklist = ({ issueId, initialChecklistItems, isSaving, setIsSaving, createIssueComment })=>{
    ...
    const handleChecklistItemBlur = (index)=>{
        ...
        if (item.label.trim() === "") {
            ...
            setChecklistItems(newItems);
            saveChecklist(newItems);
        } else saveChecklist(checklistItems);
    };
    useEffect(()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../utils/comments.js":"hPhNI"}],"hPhNI":[function(require,module,exports,__globalThis) {
/**
...
},{"./User":"enwL1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../context/WatchlistContext":"WrED9"}],"WrED9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"react":"f39IF","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru","@atlaskit/pragmatic-drag-and-drop-react-beautiful-dnd-migration":"iD7mF","./DraggableItem":"1yzcB"}],"f39IF":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iD7mF":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"guEId":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"react":"f39IF","../drag-drop-context/internal-context":"8SB2G","../drag-drop-context/rbd-invariant":"gHZ28","../draggable/data":"6qWMC","../draggable/placeholder":"30Upc","../hooks/use-drop-target-for-draggable":"eTJ7k","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1yzcB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _pragmaticDragAndDropReactBeautifulDndMigration = require("@atlaskit/pragmatic-drag-and-drop-react-beautiful-dnd-migration");
var _item = require("./Item");
...
},{"@atlaskit/pragmatic-drag-and-drop-react-beautiful-dnd-migration":"iD7mF","./Item":"2yEr4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4qoXW":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
