...
<!-- Why does this matter? Who uses it? How does it fit into the project?
...
<!-- Give the agent everything it needs to match the codebase patterns -->
...
<!-- Required packages, API keys, environment variables, etc. -->
...
- Link to similar code in the codebase as pattern references
- Define clear boundaries
- Include edge cases in acceptance criteria

❌ DON'T:
- Use vague language ("improve", "enhance", "make better")
- Assume the agent knows project conventions (point to AGENTS.md or specific files)
