...
- The WordPress.org blueprint lives at `.wordpress-org/blueprints/blueprint.json` (installs from the plugin directory).
...
See `.wordpress-org/README.md` for deploying plugin directory assets.
