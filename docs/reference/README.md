...
- Includes the main `alpaca` plugin only.
...
- Includes JavaScript `wp.hooks` extension points and the public `window.alpaca.itemDatapoints` browser API exposed by the React application.
